...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun deliverNotification(context: Context) {
        val contentIntent = Intent(context, SettingAlarm::class.java)
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            .setSmallIcon(R.drawable.alram_icon_img)    // 아이콘
            .setContentTitle("응급처치 배울 시간이에요")   // 제목
            .setContentText("주기적으로 응급처치 교육을 받아보세요!")    // 내용
